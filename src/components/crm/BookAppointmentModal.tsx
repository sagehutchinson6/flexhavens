      ...
      <div className="relative bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        {bookedRef ? (
          <div className="p-8 text-center">
            ...
            <h3 className="font-serif text-2xl font-bold text-[#1e3a5f] mb-2">Request Received</h3>
            ...
            <div className="bg-[#faf8f5] rounded-xl p-4 mb-6">
              ...
              <p className="font-mono font-bold text-lg text-[#1e3a5f]">{bookedRef}</p>
            </div>
            <Button onClick={onClose} className="w-full bg-[#1e3a5f] hover:bg-[#2d5a87]">
              Done
            </Button>
          </div>
        ) : (
          <div className="p-6">
            <h3 className="font-serif text-2xl font-bold text-[#1e3a5f] mb-1">Book an Appointment</h3>
            <p className="text-sm text-gray-500 mb-5">
              {propertyName ? (
                <>Schedule a viewing or consultation for <strong className="text-[#1e3a5f]">{propertyName}</strong>.</>
              ) : (
                "Schedule a property inspection, virtual tour, meeting or consultation with our team."
              )}
            </p>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2.5 rounded-xl border text-sm font-medium transition text-left ${
                      active
                        ...
                        : "border-gray-200 text-gray-600 hover:border-[#c8956c]"
                    }`}
                  >
                    <Icon className={`w-4 h-4 shrink-0 ${active ? "text-[#c8956c]" : "text-[#c8956c]"}`} />
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#1e3a5f]/30"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e3a5f]/30 resize-none"
            ...
            <Button
              ...
              className="w-full mt-4 bg-gradient-to-r from-[#1e3a5f] to-[#2d5a87] hover:shadow-xl transition text-base py-6"
            >
              {bookMutation.isPending ? "Submitting…" : "Request Appointment"}
            </Button>
            <p className="text-[11px] text-gray-400 text-center mt-2">
              All times are West Africa Time (WAT). Our team confirms every request personally.
            </p>
          </div>
        )}
      </div>
