...
const priorityStyles: Record<string, string> = {
  ...
  normal: "bg-[#1e3a5f]/10 text-[#1e3a5f]",
      ...
      {ANNOUNCEMENT_THEME_COLORS.map((c) => (
        <button
          ...
          className={`w-8 h-8 rounded-lg border-2 transition ${
            value === c.value ? "border-[#1e3a5f] scale-110" : "border-gray-200 hover:border-gray-300"
          }`}
...
function Toggle({ label, checked, onChange }: { label: string; checked: boolean; onChange: (v: boolean) => void }) {
  return (
    ...
    >
      <span
        className={`w-9 h-5 rounded-full relative transition-colors ${checked ? "bg-[#1e3a5f]" : "bg-gray-300"}`}
      >
        <span
          ...
          <div>
            ...
            {form.displayMode === "single" && (
              <select
                ...
                className="mt-3 w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e3a5f]/30"
              >
                ...
                {ANNOUNCEMENT_SPEEDS.map((s) => (
                  <button
                    ...
                    className={`px-3.5 py-1.5 rounded-lg text-sm font-medium transition ${
                      form.speed === s.key ? "bg-[#1e3a5f] text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                    }`}
                  >
                    {s.label}
                  </button>
              ...
              <div className="flex gap-2">
                {ANNOUNCEMENT_DIRECTIONS.map((d) => (
                  <button
                    ...
                    className={`px-3.5 py-1.5 rounded-lg text-sm font-medium transition ${
                      form.direction === d.key ? "bg-[#1e3a5f] text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                    }`}
                  >
                    {d.label}
                  </button>
            ...
            <div className="flex flex-wrap gap-2">
              {(
                ...
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-lg text-sm font-medium transition ${
                    action === o.key ? "bg-[#1e3a5f] text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                  }`}
                >
                  {o.label}
                </button>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="font-serif text-2xl font-bold text-[#1e3a5f] flex items-center gap-2">
            <Megaphone className="w-6 h-6 text-[#c8956c]" />
            Announcement Bar
          </h2>
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2.5 rounded-lg text-sm font-medium transition flex items-center gap-2 ${
              settingsOpen ? "bg-[#c8956c] text-white" : "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50"
            }`}
          >
              ...
              <div key={a.id} className="py-4 flex flex-col lg:flex-row lg:items-center gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {a.title && <span className="font-semibold text-[#1e3a5f] text-sm">{a.title}</span>}
                  </div>
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  <button
                    ...
                    title="Preview"
                    className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 hover:text-[#1e3a5f] transition"
                  >
      ...
      {preview && settings && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl p-6">
            <h3 className="font-serif text-lg font-bold text-[#1e3a5f] mb-1">Preview</h3>
      ...
      {confirmDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
            <h3 className="font-serif text-lg font-bold text-[#1e3a5f]">Delete this announcement?</h3>
