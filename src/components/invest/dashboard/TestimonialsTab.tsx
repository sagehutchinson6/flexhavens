  ...
  return (
    <div className="space-y-6">
      <SectionCard
        ...
        subtitle="Tell others about your journey with FlexHavens — approved testimonials appear on our website"
        action={
          eligible && !hasActive && !formOpen ? (
            <Button onClick={() => setFormOpen(true)} className="bg-[#1e3a5f] hover:bg-[#2d5a87]">
      ...
      >
        {!eligibilityQuery.data ? (
          ...
          <EmptyState
            ...
            text="Once you complete account verification, make an investment, or purchase a property, you can share your experience here."
          />
        ) : formOpen ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Share your experience with FlexHavens — the process, the team, the outcome…"
                />
              </div>
              <div className="grid sm:grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-500 mb-1.5">Investment Plan (optional)</label>
              ...
              <div>
                ...
                {photo ? (
                  <div className="flex items-center gap-3">
                    <img src={photo.dataUrl} alt="Profile" className="w-14 h-14 rounded-full object-cover border-2 border-[#c8956c]" />
          ...
          <EmptyState
            ...
            text="Your feedback helps other buyers and investors trust FlexHavens. It only takes a minute."
            action={
              <Button onClick={() => setFormOpen(true)} className="bg-[#1e3a5f] hover:bg-[#2d5a87]">
                <Star className="w-4 h-4 mr-1.5" /> Write a Testimonial
              </Button>
          ...
          <div className="space-y-4">
            {mine.map((t) => (
              <div key={t.id} className="border border-gray-200 rounded-xl p-5">
                ...
                {t.title && <p className="font-bold text-[#1e3a5f] mb-1">{t.title}</p>}
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 mt-3 text-xs text-gray-400">
                  <span>{new Date(t.createdAt).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" })}</span>
                  ...
                  {t.featured === "yes" && t.status === "approved" && <span className="text-[#c8956c] font-semibold">Featured on homepage ★</span>}
                </div>
