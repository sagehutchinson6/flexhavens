...
const GROUP_FILTERS = [
  ...
  { id: "funding", label: "Investment Funding" },
  { id: "earnings", label: "ROI / Earnings" },
...
export function walletActivityLabel(tx: any): string {
  if (tx.type === "refund") {
    ...
    if (ref.startsWith("LIQ-") || desc.includes("liquidation")) return "Liquidation";
    return "Refund";
  }
  switch (tx.type) {
    case "deposit":
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-3 mb-5">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {hasFilters && (
              <Button variant="ghost" size="sm" onClick={clearFilters} className="text-[#c8956c]">
                Clear
              </Button>
            )}
          </div>
                    ...
                    >
                      ...
                      <td className="py-3.5 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-xs font-semibold text-[#1e3a5f] hover:text-[#c8956c] transition"
                        >
              ...
              {items.map((tx: any) => (
                ...
                >
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-[#1e3a5f]">{walletActivityLabel(tx)}</p>
