...
export default function SettingsTab({ investor }: { investor: any }) {
  ...
  const downloadStatement = async () => {
    ...
    const lines: string[] = [
      "FLEXHAVENS INVEST — ACCOUNT STATEMENT",
      ...
      "",
      "FlexHavens Real Estate Development Ltd. · Abuja, FCT, Nigeria",
    ...
    a.href = url;
    a.download = `flexhavens-statement-${new Date().toISOString().slice(0, 10)}.txt`;
    a.click();
    ...
    <div className="grid lg:grid-cols-2 gap-6">
      ...
      <SectionCard title="Profile Settings" subtitle="Your personal information">
        <div className="space-y-4">
          {/* Profile picture */}
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 bg-[#faf8f5] rounded-xl p-4 border border-gray-100">
            <InvestorAvatar name={investor?.name} avatar={photoPending ?? investor?.avatar} size="xl" />
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-[#1e3a5f]">Profile Picture</p>
              ...
              {photoPending !== null ? (
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    className="bg-[#1e3a5f] h-8 text-xs"
                  >
                ...
                <div className="flex flex-wrap gap-2">
                  <label className="cursor-pointer">
                    <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#1e3a5f] border border-gray-200 rounded-lg px-3 py-2 hover:bg-white transition">
      ...
      <SectionCard title="Statements & Documents" subtitle="Download your account records">
        <div className="space-y-4">
          <div className="flex items-center gap-4 bg-[#faf8f5] rounded-xl p-5">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-[#1e3a5f] text-sm">Full Account Statement</p>
