  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-4 grid grid-cols-2 md:grid-cols-6 gap-2">
        ...
        <button onClick={() => setFilters({ search: "", adminId: "", module: "", dateFrom: "", dateTo: "", quick: "" })} className="text-xs font-semibold text-gray-500 border border-gray-200 rounded-lg hover:text-[#1e3a5f] transition flex items-center justify-center gap-1.5">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-5">
        ...
        {timelineQuery.isLoading ? (
          ...
          <div className="relative pl-6 space-y-4 before:absolute before:left-[9px] before:top-1 before:bottom-1 before:w-0.5 before:bg-gray-100">
            {rows.map((r) => {
              const day = new Date(r.createdAt).toLocaleDateString("en-GB", { weekday: "long", day: "2-digit", month: "long", year: "numeric" });
                ...
                <div key={r.id}>
                  ...
                  <div className="relative">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <p className="text-sm font-semibold text-[#1e3a5f]">{activityActionLabel(r.action)}</p>
