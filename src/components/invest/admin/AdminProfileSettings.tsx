  ...
  return (
    <div className="grid lg:grid-cols-2 gap-6 items-start">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        <h3 className="text-lg font-bold text-[#1e3a5f] font-serif flex items-center gap-2 mb-5">
          <UserCircle className="w-5 h-5 text-[#c8956c]" /> Profile Information
        </h3>

        <div className="flex items-center gap-4 mb-5">
          <div className="w-16 h-16 rounded-full bg-[#1e3a5f] flex items-center justify-center text-white text-xl font-bold overflow-hidden shrink-0">
            {avatar ? <img src={avatar} alt="Profile" className="w-full h-full object-cover" /> : me.displayName.charAt(0).toUpperCase()}
          </div>
          <label className="cursor-pointer">
            <span className="inline-flex items-center gap-1.5 text-sm font-medium text-[#1e3a5f] border border-gray-200 rounded-lg px-3 py-2 hover:bg-[#faf8f5] transition">
        ...
        <div className="mt-4">
          ...
          <p className="mt-1.5 text-sm font-semibold text-[#1e3a5f] capitalize">{me.role} Administrator</p>
        </div>

        <Button
          className="mt-6 bg-gradient-to-r from-[#1e3a5f] to-[#2d5a87]"
      ...
      <div className="space-y-6">
        {/* Email change */}
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <h3 className="text-lg font-bold text-[#1e3a5f] font-serif flex items-center gap-2 mb-2">
            <Mail className="w-5 h-5 text-[#c8956c]" /> Change Email Address
          </h3>
          <p className="text-sm text-gray-500 mb-4">
            Current: <span className="font-semibold text-[#1e3a5f]">{me.email}</span>
            {me.pendingEmail && (
          ...
          <Button
            variant="outline"
            className="mt-5 border-[#1e3a5f] text-[#1e3a5f]"
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <h3 className="text-lg font-bold text-[#1e3a5f] font-serif flex items-center gap-2 mb-5">
            <KeyRound className="w-5 h-5 text-[#c8956c]" /> Change Password
          </h3>
          <div>
