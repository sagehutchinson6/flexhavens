  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl max-w-md w-full shadow-2xl p-6">
        ...
        <h3 className="font-serif text-xl font-bold text-[#1e3a5f] mb-4">Schedule Follow-up</h3>
            ...
            <div className="flex flex-wrap gap-1.5 mt-2">
              {FOLLOWUP_SUGGESTIONS.map((s) => (
                <button
                  ...
                  className="text-[11px] px-2 py-1 rounded-full bg-[#1e3a5f]/5 text-[#1e3a5f] hover:bg-[#1e3a5f]/10 transition"
                >
                  {s}
                </button>
              ))}
        ...
        <Button onClick={submit} disabled={createMutation.isPending} className="w-full mt-4 bg-[#1e3a5f] hover:bg-[#2d5a87]">
