          ...
          return (
            <div key={stage.stageKey} className="w-64 shrink-0 bg-gray-50 rounded-xl border border-gray-200 flex flex-col max-h-[70vh]">
              <div className="px-3 py-2.5 border-b border-gray-200 flex items-center gap-2">
                ...
                <p className="text-xs font-bold text-[#1e3a5f] truncate">{stage.label}</p>
                ...
                {inStage.map((l) => (
                  <div key={l.id} className="bg-white rounded-lg border border-gray-200 p-3 shadow-sm hover:shadow transition">
                    <button className="text-left w-full" onClick={() => setProfileId(l.id)}>
                      <p className="text-sm font-semibold text-[#1e3a5f] leading-tight">{l.fullName}</p>
                      ...
                      <div className="flex items-center justify-between mt-1.5">
                        ...
                        {l.assignedAdminName && (
                          <span className="text-[10px] text-gray-500 flex items-center gap-1">
                            <UserRound className="w-3 h-3 text-[#c8956c]" />
                    ...
                    <div className="relative mt-2">
                      <button
                        ...
                        className="w-full text-[10px] font-semibold text-gray-400 hover:text-[#1e3a5f] flex items-center justify-center gap-1 py-1 rounded border border-dashed border-gray-200 hover:border-[#c8956c] transition"
                      >
