  ...
  return (
    <div className="border border-gray-200 rounded-xl p-3">
      <div className="flex items-center justify-between gap-2 mb-2">
        <p className="text-sm font-semibold text-[#1e3a5f] flex items-center gap-2 min-w-0">
        ...
        <a
          href={doc.dataUrl}
          download={doc.name}
          className="shrink-0 text-xs font-medium text-[#1e3a5f] hover:underline flex items-center gap-1"
        >
                ...
                {rows.map((r) => (
                  <tr key={r.id} className="hover:bg-[#faf8f5]">
                    <td className="py-3.5 pr-4">
                      <p className="font-semibold text-[#1e3a5f]">{r.investorName}</p>
                    ...
                    <td className="py-3.5">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-[#1e3a5f] text-white text-xs font-medium hover:bg-[#2d5a87] transition flex items-center gap-1.5"
                      >
              ...
              <>
                ...
                {(detail.request.status === "pending" || detail.request.status === "more_info") && (
                  <div className="mt-6 border-t border-gray-100 pt-5">
                    <p className="text-sm font-semibold text-[#1e3a5f] mb-3">Review Decision</p>
                ...
                {detail.investor && (
                  <div className="mt-6 border-t border-gray-100 pt-5">
                    <p className="text-sm font-semibold text-[#1e3a5f] mb-3">Tier Management</p>
                    <textarea
                      value={tierNote}
                      ...
                      className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e3a5f]/30 resize-y mb-3"
                    />
                    <div className="flex flex-wrap gap-2">
                      {KYC_TIERS.filter((t) => t.key !== detail.investor!.verificationTier).map((t) => (
                        <button
                          ...
                          disabled={busy}
                          className="px-3.5 py-2 rounded-lg bg-[#1e3a5f] text-white text-xs font-medium hover:bg-[#2d5a87] transition disabled:opacity-50 flex items-center gap-1.5"
                        >
                ...
                {/* History */}
                <div className="mt-6 border-t border-gray-100 pt-5">
                  <p className="text-sm font-semibold text-[#1e3a5f] mb-3 flex items-center gap-2">
                    <History className="w-4 h-4 text-[#c8956c]" />
                  ...
                  {detail.history.length === 0 ? (
                    ...
                    <div className="space-y-3 max-h-56 overflow-y-auto pr-2">
                      {detail.history.map((h) => (
                        <div key={h.id} className="border-l-2 border-[#c8956c]/30 pl-3">
