...
export default function AdminLiquidations() {
  ...
  const buildExportRows = () => ({
    columns: [
      "Request ID", "Investor", "Email", "Investment", "Plan", "Invested",
  ...
  const exportPdf = async () => {
    ...
    try {
      ...
      doc.text("FlexHavens Liquidation Report", 14, 18);
      doc.setFontSize(10);
      ...
      doc.save(`flexhavens-liquidations-${statusFilter}-${new Date().toISOString().slice(0, 10)}.pdf`);
  ...
  const exportCsv = () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `flexhavens-liquidations-${statusFilter}-${new Date().toISOString().slice(0, 10)}.csv`;
      a.click();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
        <StatCard icon={CircleDollarSign} label="Total Requests" value={String(stats?.total ?? 0)} tone="bg-[#1e3a5f]/5 text-[#1e3a5f]" />
        ...
        <StatCard icon={Banknote} label="Total Liquidated" value={formatCurrency(stats?.totalLiquidated ?? 0)} tone="bg-[#c8956c]/10 text-[#b07d52]" />
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center gap-4 mb-6">
            ...
            {statusTabs.map((t) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                  statusFilter === t.id
                    ? "bg-gradient-to-r from-[#1e3a5f] to-[#2d5a87] text-white shadow"
                    : "bg-[#faf8f5] text-gray-600 hover:text-[#1e3a5f]"
                }`}
              >
                {t.label}
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search investor, plan or ID..."
        ...
        {listQuery.isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="font-semibold text-[#1e3a5f]">No liquidation requests</p>
                  ...
                  <tr key={r.id} className="hover:bg-[#faf8f5] transition">
                    ...
                    <td className="py-4 pr-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0">
                          <p className="font-semibold text-[#1e3a5f] truncate">{r.investorName}</p>
                          <p className="text-xs text-gray-400 truncate">{r.investorEmail}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 pr-4">
                      <p className="font-medium text-[#1e3a5f]">{r.projectName}</p>
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b sticky top-0 bg-white rounded-t-2xl">
              <h3 className="text-lg font-bold text-[#1e3a5f] font-serif flex items-center gap-2">
                <CircleDollarSign className="w-5 h-5 text-[#c8956c]" />
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-[#faf8f5] rounded-xl p-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="font-bold text-[#1e3a5f] truncate">{selected.investorName}</p>
                ...
                <div className="bg-[#faf8f5] rounded-xl p-4">
                  ...
                  <p className="font-bold text-[#1e3a5f]">{selected.projectName}</p>
              ...
              <div className="border border-gray-200 rounded-xl p-4 space-y-2.5 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-[#1e3a5f]">{formatCurrency(selected.principalAmount)}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-[#1e3a5f]">{formatCurrency(selected.accruedProfit)}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="border-t pt-2.5 flex justify-between items-center">
                  <span className="font-bold text-[#1e3a5f]">Estimated Payout</span>
                  <span className="text-lg font-bold text-[#c8956c]">{formatCurrency(selected.estimatedValue)}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="bg-[#faf8f5] rounded-xl p-3">
                  ...
                  <p className="font-semibold text-[#1e3a5f]">{formatDate(selected.requestedAt)}</p>
                </div>
                <div className="bg-[#faf8f5] rounded-xl p-3">
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1.5 w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#c8956c]/40 focus:border-[#c8956c]"
                    />
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="Internal note / message to the investor..."
                      className="mt-1.5 w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#c8956c]/40 focus:border-[#c8956c] resize-none"
                    />
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button
                      className="flex-1 bg-gradient-to-r from-[#1e3a5f] to-[#2d5a87]"
                      disabled={review.isPending}
