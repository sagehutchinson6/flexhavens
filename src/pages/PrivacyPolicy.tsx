      ...
      <main className="pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-serif font-bold text-[#1e3a5f] mb-4">Privacy Policy</h1>
            <p className="text-gray-600">Last updated: June 2026</p>
          </div>

          <div className="prose max-w-none text-gray-600">
            <h2 className="text-xl font-bold text-[#1e3a5f] mb-3">1. Introduction</h2>
            <p className="mb-4">FlexHavens Real Estate Development Ltd. ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase.</p>
            ...
            <h2 className="text-xl font-bold text-[#1e3a5f] mb-3">4. Information Sharing</h2>
            <p className="mb-4">We do not sell your personal information. We may share your information with:</p>
            <ul className="list-disc pl-6 mb-4 space-y-1">
              <li>Legal and documentation partners for title processing purposes</li>
            ...
            <p className="mb-4">Under the Nigeria Data Protection Regulation (NDPR) and other applicable privacy laws, you have the right to:</p>
            <ul className="list-disc pl-6 mb-4 space-y-1">
