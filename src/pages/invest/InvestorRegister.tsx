...
export default function InvestorRegister() {
  ...
  const register = trpc.investorAuth.register.useMutation({
    onSuccess: (data) => {
      toast.success("Account created! Welcome to FlexHavens Invest.");
      refetch();
    ...
    <InvestAuthShell
      ...
      subtitle={
        selectedPlan
          ...
          : "Join FlexHavens Invest and start building wealth"
      }
    >
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <CountrySelect
                ...
                className="w-full h-11 rounded-md border border-input bg-background pl-9 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#c8956c]/40 focus:border-[#c8956c]"
              />
            </div>
          </div>
        </div>
        ...
        <div>
          <Label htmlFor="referralCode" className="flex items-center gap-1.5">
            <Gift className="w-4 h-4 text-[#c8956c]" />
        ...
        <label className="flex items-start gap-3 text-sm text-gray-600 cursor-pointer pt-1">
          ...
          <span>
            I agree to the{" "}
            <Link to="/terms-conditions" className="text-[#c8956c] font-medium hover:underline">
              Terms &amp; Conditions
            </Link>{" "}
            and{" "}
            <Link to="/invest#risk-disclosure" className="text-[#c8956c] font-medium hover:underline">
              Risk Disclosure
            </Link>
        ...
        <Button
          ...
          className="w-full h-12 bg-gradient-to-r from-[#c8956c] to-[#b07d52] hover:shadow-lg transition text-base font-semibold"
        >
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link to="/invest/login" className="text-[#1e3a5f] hover:text-[#2d5a87] font-semibold">
            Sign in
          </Link>
        </p>
      </form>
