...
export default function InvestorLogin() {
  ...
  return (
    <InvestAuthShell title="Welcome Back" subtitle="Enter your credentials to access your investor dashboard">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="text-sm text-[#c8956c] hover:text-[#b07d52] font-medium"
          >
            Forgot password?
          </Link>
        </div>
