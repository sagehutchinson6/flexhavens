      ...
      <header className="fixed top-0 inset-x-0 bg-white/95 backdrop-blur-md border-b z-40">
        <div className="flex items-center justify-between h-16 px-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <Link to="/" className="flex items-center gap-2.5">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg font-bold text-[#1e3a5f] font-serif leading-tight">FlexHavens Invest</h1>
                <p className="text-[10px] text-gray-400 -mt-0.5 tracking-widest uppercase">Investor Dashboard</p>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link
              to="/"
              className="hidden md:flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#1e3a5f] transition"
            >
            ...
            {isAdmin && (
              <Link
                to="/admin/dashboard"
                className="flex items-center gap-1.5 text-sm font-medium text-[#b07d52] hover:text-[#c8956c] transition"
              >
            ...
            <button
              ...
              className="relative p-2 text-gray-500 hover:text-[#1e3a5f] transition"
            >
              <Bell className="w-5 h-5" />
              {unread > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-[#c8956c] text-white text-[10px] w-4.5 h-4.5 w-5 h-5 rounded-full flex items-center justify-center font-bold">
                  {unread > 9 ? "9+" : unread}
                </span>
              )}
            </button>
            <div className="flex items-center gap-2.5 pl-2 sm:pl-4 border-l">
              <div className="w-9 h-9 rounded-full bg-[#1e3a5f] flex items-center justify-center text-white font-bold text-sm overflow-hidden">
                {investor?.avatar ? (
              ...
              <div className="hidden sm:block">
                <p className="text-sm font-semibold text-[#1e3a5f] leading-tight">{investor?.name}</p>
          ...
          <div className="p-4 mt-4">
            <div className="bg-[#1e3a5f] rounded-2xl p-5 text-white">
              ...
              <p className="text-sm font-semibold mt-1.5 leading-relaxed">
                Browse our luxury Abuja properties from ₦38,500,000 — outright or with a mortgage.
              </p>
              <Link
                to="/#catalog"
                className="inline-block mt-3 text-xs font-bold text-[#c8956c] hover:text-white transition"
              >
                View Catalog →
              </Link>
            </div>
