        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              <Shield className="w-6 h-6 text-[#c8956c]" />
              <h1 className="text-xl font-bold">FlexHavens Admin</h1>
            </div>
        ...
        <div className="flex gap-4 mb-6">
          {canOrders && (
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition ${
                activeTab === "orders" ? "bg-[#1e3a5f] text-white" : "bg-white text-gray-600 hover:bg-gray-100"
              }`}
            >
          ...
          {canContacts && (
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition ${
                activeTab === "contacts" ? "bg-[#1e3a5f] text-white" : "bg-white text-gray-600 hover:bg-gray-100"
              }`}
            >
            ...
            <Card className="p-4 mb-6">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <select
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#1e3a5f]/20"
                >
                      ...
                      return (
                        <Fragment key={order?.id ?? Math.random()}>
                          <tr className="hover:bg-gray-50 transition">
                            <td className="px-4 py-3 font-mono text-sm text-[#1e3a5f]">
                            ...
                            <td className="px-4 py-3">
                              <button
                                ...
                                className="text-[#1e3a5f] hover:text-[#2d5a87] transition"
                              >
                                ...
                                <div className="space-y-4">
                                  ...
                                  {customer && (
                                    <div className="grid md:grid-cols-2 gap-4">
                                      <div>
                                        <h4 className="font-semibold text-sm text-[#1e3a5f] mb-2">Customer Details</h4>
                                        <div className="text-sm space-y-1">
                                          <p><span className="text-gray-500">Name:</span> {customer.firstName} {customer.middleName} {customer.lastName}</p>
                                          <p><span className="text-gray-500">Email:</span> {customer.email}</p>
                                          <p><span className="text-gray-500">Phone:</span> {customer.phone}</p>
                                          <p><span className="text-gray-500">Address:</span> {customer.city}, {customer.state}, {customer.country} {customer.postalCode}</p>
                                        </div>
                                      </div>
                                      <div>
                                        <h4 className="font-semibold text-sm text-[#1e3a5f] mb-2">Order Items</h4>
                                  ...
                                  <div className="border-t pt-4">
                                    <h4 className="font-semibold text-sm text-[#1e3a5f] mb-3">Update Purchase Stage <span className="font-normal text-gray-400">(buyer is emailed automatically)</span></h4>
                                  ...
                                  {/* Payment Update */}
                                  <div className="border-t pt-4">
                                    <h4 className="font-semibold text-sm text-[#1e3a5f] mb-2">Payment Status</h4>
                                    <div className="flex gap-2">
                                  ...
                                  {safeGet(orderData, "adminNotes") && (
                                    <div className="border-t pt-4">
                                      <h4 className="font-semibold text-sm text-[#1e3a5f] mb-2">Admin Notes</h4>
                                  ...
                                  {history.length > 0 && (
                                    <div className="border-t pt-4">
                                      <div className="flex justify-between items-center mb-2">
                                        <h4 className="font-semibold text-sm text-[#1e3a5f]">Purchase Progress History ({history.length})</h4>
                                        {deleteHistory && (
                                          <Button
                                            type="button"
                                            size="sm"
                                      ...
                                      <div className="space-y-2">
                                        {history.map((h: any, i: number) => (
                                          <div key={i} className="text-sm flex items-start gap-2">
                                            <div className="w-2 h-2 bg-[#c8956c] rounded-full mt-1.5 flex-shrink-0" />
                                            <div>
                                  ...
                                  {/* Purchase Documents */}
                                  <div className="border-t pt-4">
                                    <h4 className="font-semibold text-sm text-[#1e3a5f] mb-2">
                                    ...
                                    <div className="flex items-center gap-2 mb-3">
                                      <label className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-[#1e3a5f] text-white text-sm cursor-pointer hover:bg-[#2d5a87] transition">
                                        ...
                                        {orderDocuments.map((d: any) => (
                                          <div key={d.id} className="flex items-center justify-between bg-white border rounded-lg px-3 py-2">
                                            <div className="flex items-center gap-2 min-w-0">
                                              <FileText className="w-4 h-4 text-[#c8956c] flex-shrink-0" />
                                            ...
                                            <div className="flex items-center gap-1 flex-shrink-0">
                                              <a
                                                href={d.dataUrl}
                                                download={d.name}
                                                className="p-1.5 text-[#1e3a5f] hover:bg-gray-100 rounded"
                                                title="Download"
                                              >
                ...
                <tbody className="divide-y divide-gray-100">
                  {contacts?.map((contact: any) => (
                    <tr key={contact?.id ?? Math.random()} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-600 max-w-xs truncate">{contact?.message}</td>
                      <td className="px-4 py-3 text-sm text-gray-500">
