      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-14 h-14 bg-[#1e3a5f] rounded-xl flex items-center justify-center mb-4 relative overflow-hidden">
              <Shield className="w-7 h-7 text-white" />
              <div className="absolute top-0 right-0 w-3.5 h-3.5 bg-red-600 rounded-full border-2 border-white"></div>
            </div>
            <h1 className="text-2xl font-bold text-[#1e3a5f] font-serif">Admin Portal</h1>
            <p className="text-sm text-gray-500 mt-1">FlexHavens Management Access</p>
          </div>
