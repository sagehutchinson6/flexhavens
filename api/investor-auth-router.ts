  ...
  register: publicQuery
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      void notifyUser(investorId, {
        ...
        title: "Welcome to FlexHavens Invest",
        message: "Your investor account is ready. Verify your email, make your first deposit, and start building wealth with real estate.",
        emailIntro: `Welcome to FlexHavens Invest, ${input.name.trim()}! Your account has been created successfully. Verify your email, complete your profile, make your first deposit and start building wealth with real estate.`,
      ...
      if (referrerId) {
        void notifyUser(referrerId, {
          ...
          category: "referrals",
          title: "New Referral Joined",
          message: `${input.name.trim()} joined FlexHavens Invest with your referral code.`,
          severity: "success",
  ...
  requestEmailChange: investorQuery
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      void notifyUser(ctx.investor.id, {
        ...
        emailIntro: `A request was made to change the email address on your FlexHavens account to ${newEmail}. Your current email remains active until the new address is verified.`,
