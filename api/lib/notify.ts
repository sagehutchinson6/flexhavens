...
import { appBaseUrl, buildEventEmail, sendEmail, Company, type EventEmailDetail } from "./email";
...
export function fmtDateTime(d: Date): string {
  return `${d.toLocaleDateString("en-GB", { day: "2-digit", month: "long", year: "numeric" })} at ${d.toLocaleTimeString("en-GB", { hour: "2-digit", minute: "2-digit" })} (WAT)`;
}
