  ...
  create: publicQuery
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      void generatePdfDocument({
        ...
        note: "This agreement records your property purchase with FlexHavens Real Estate Development Ltd. Title documentation and handover follow the purchase progress stages.",
      });
      void generatePdfDocument({
        ownerEmail: input.customer.email,
        ownerName: buyerName,
